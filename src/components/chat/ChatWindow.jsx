            ...
            {typingText && (
                <div className="flex items-center gap-2 px-4 py-1 animate-fade-in">
                    <div className="flex items-center gap-1">
                        <div className="w-1.5 h-1.5 bg-violet-400/70 rounded-full animate-bounce [animation-delay:-0.3s]" />
                        <div className="w-1.5 h-1.5 bg-violet-400/70 rounded-full animate-bounce [animation-delay:-0.15s]" />
                        <div className="w-1.5 h-1.5 bg-violet-400/70 rounded-full animate-bounce" />
                    </div>
